package com.mohitproject.gitapijsonapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.githubedt = (EditText) findViewById(R.id.et_github_user);  // Link our github user text box.
        this.push = (Button) findViewById(R.id.btn_get_repos);  // Link our click button.
        this.showRepos = (TextView) findViewById(R.id.tv_repo_list);  // Link our repository list text output box.
        this.showRepos.setMovementMethod(new ScrollingMovementMethod());  // This makes our text box scrollable.
        requestQueue = Volley.newRequestQueue(this);  // This setups up a new request queue which we will need to make HTTP requests.
    }

    private void clearRepoList() {
        // This will clear the repo list (set it as a blank string).
        this.showRepos.setText("");
    }
    ...
    private void addToRepoList(String repoName, String lastUpdated) {
        ...
        String currentText = showRepos.getText().toString();
        this.showRepos.setText(currentText + "\n\n" + strRow);
    }
    ...
    public void getReposClicked(View v) {
        ...
        getRepoList(githubedt.getText().toString());
    }
    }
